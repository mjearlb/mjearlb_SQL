...
-- Drop the existing table if any and continue.
...
-- Retrieves the total score and displays the resultant 
-- column as Total which is called as an alias name.
...
-- Count(*) returns the record count, because here it is entire Student table
-- you will get total student count.
